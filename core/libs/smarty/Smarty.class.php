...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     */
    public static $_muted_directories = array('./compiler/' => null, './cache/' => null);
     ...
     * @var array
     */
    private $template_dir = array('./assets/templates/');
     ...
     * @var string
     */
    public $joined_template_dir = './assets/templates/';
    ...
    public function __construct()
    {
        ...
        if ($this->template_dir[0] !== '.assets/templates/' || isset($this->template_dir[1])) {
        ...
        if ($this->compile_dir !== './compiler/') {
            unset(self::$_muted_directories['./compiler/']);
